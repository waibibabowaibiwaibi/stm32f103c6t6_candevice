...
void HAL_PCD_MspInit(PCD_HandleTypeDef * hpcd)
{
  ...
  /* USB and CAN RX FIFO0 share this vector on STM32F103. */
...
{
  /* Common STM32F103C6 boards wire the USB D+ pull-up permanently, so there
     is no board-controlled disconnect pin to drive here. */
  (void)hpcd;
  (void)state;
}
